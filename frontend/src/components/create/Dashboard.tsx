	        ...
	        >
			  ...
			  <div>
				  <div className="flex">
			          ...
			          <span className="ptext-lg" style={{paddingLeft: "10px"}}>{survey.name}</span>
				  </div>
				  <div className="flex">
					  <img src="information.png" alt="crypto task" style={{ width: "25px", height: "25px"}}></img>
			          <p style={{paddingLeft: "10px"}}>{survey.description}</p>
				  </div>
			  </div>
			  <div>
			  	<img src="email.png" alt="crypto task" style={{ width: "25px", height: "25px"}}></img>
			  	<p className="text-center">{survey.marketReply}</p>
			  </div>
			  <div>
			  	<img src="dollar.png" alt="crypto task" style={{ width: "25px", height: "25px"}}></img>
